...
console.log('Price = ' + price + ', refresh rate = ' + refreshRate);
...
const [ wifiConn, bluetoothConn ] = connectivity;
console.log('Wifi = ' + wifiConn + ', bluetooth = ' + bluetoothConn);
...
const [ tvsize1, tvsize2, tvsize3 ] = tvSizes;
console.log('size1 = ' + tvsize1 + ' size3 = ' + tvsize3 );
...
console.log('name = ' + name + ' adress = ' + adress);

// opdracht 7: Destructure beide zinnetjes uit de return value van de getDetails functie
// en log ze in de terminal. Let op: de functie verwacht argumenten bij het aanroepen!

function getDetails(name, age) {
    return [`Your name is ${name}`, `You are ${age} years old`];
}

const [ myName, myAge ] = getDetails("Anouk", 26);
