...
console.log(getCircumference(4));
...
function getCircumferenceRounded(diameter) {
    return Math.round(getCircumference(diameter));
}
console.log(getCircumferenceRounded(4));
